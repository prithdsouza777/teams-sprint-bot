 ...
 * @public
 */
export declare type CapabilityResolutionReason = 'Capable' | 'CapabilityNotApplicableForTheCallType' | 'ClientRestricted' | 'UserPolicyRestricted' | 'RoleRestricted' | 'FeatureNotSupported' | 'MeetingRestricted' | 'NotInitialized' | 'NotCapable' | 'TeamsPremiumLicenseRestricted';
...
export declare interface IncomingCallCommon {
     ...
     */
    readonly customContext?: CustomContextOptions;
    /**
